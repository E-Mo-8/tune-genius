...
const useAudio = (nftAlbum,iIndex) => {
  ...
  const audioRef = useRef(new Audio(resolveLink(nftAlbum[trackIndex].src)));
  ...
  useEffect(() => {
    audioRef.current.pause();
    audioRef.current = new Audio(resolveLink(nftAlbum[trackIndex].src));
